...
class Test_03_ifnull_function:
  ...
  def test_03_ifnull_function(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "test_ifnull-tr")))
    time.sleep(1)
    ...
    assert self.driver.find_element(By.NAME, "test_ifnull").get_attribute("value") == "165"
    ...
    assert self.driver.find_element(By.NAME, "test_ifnull").get_attribute("value") == "60"
