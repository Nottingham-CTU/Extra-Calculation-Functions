...
class Test_07_sysvar_function:
  ...
  def test_07_sysvar_function(self):
    ...
    assert len(self.driver.find_elements(By.CSS_SELECTOR, "body[data-sysvar-set]")) > 0
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.ID, "test_sysvar-tr")))
    time.sleep(1)
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "input[name=\"test_sysvar\"]").get_attribute("value") == self.vars["sysvarValue"]
